...
class TestSwitchToConstructorFromLogo:
    def test_switch_to_constructor_from_logo(self, driver):
        ...
        logo_button = driver.find_element(*StellarburgersLocators.LOGO_BUTTON)
        logo_button.click()
