...
class TestAuthFromLoginButton:
    def test_auth_from_login_button(self, driver):
        ...
        WebDriverWait(driver, 10).until(
            expected_conditions.text_to_be_present_in_element(StellarburgersLocators.PLACE_ORDER_BUTTON, 'Оформить заказ'))
